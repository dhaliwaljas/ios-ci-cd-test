...
class ApiClient {
  ...
  ApiClient({this.basePath = "https://virtserver.swaggerhub.com/hasiltech/useridentity/1.0.0"}) {
  }
    ...
    try {
      switch (targetType) {
        ...
        case 'LoginResponseData':
          return LoginResponseData.fromJson(value);
        case 'NewUserRequest':
          return NewUserRequest.fromJson(value);
        case 'NewUserResponse':
          return NewUserResponse.fromJson(value);
        ...
        case 'UserIdentityListResponse':
          return UserIdentityListResponse.fromJson(value);
        default:
          {
            Match match;
            if (value is List &&
